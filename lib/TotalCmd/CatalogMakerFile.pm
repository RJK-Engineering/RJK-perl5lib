...
---+ package TotalCmd::CatalogMakerFile
...
---+++ new(%attrs) -> TotalCmd::CatalogMakerFile
Returns a new =TotalCmd::CatalogMakerFile= object.
...
# File name                                                                                                                                                                              Size
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------    ---------------
# total files 5856    total size 946,971,834,783
        }
    }
    close F;
